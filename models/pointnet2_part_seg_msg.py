...
class GetModel(nn.Module):
    def __init__(self, num_classes, normal_channel=False, channels_offset: int = None):
        ...
        self.sa1 = PointNetSetAbstractionMsg(512, [0.1, 0.2, 0.4], [32, 64, 128], 3+(additional_channel*(additional_channel>0)), [[32, 32, 64], [64, 64, 128], [64, 96, 128]])
    ...
    def forward(self, xyz, cls_label):
        ...
        cls_label_one_hot = cls_label.view(B,cls_label.shape[2], 1).repeat(1, 1, N)
