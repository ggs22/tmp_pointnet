...
class GetModel(nn.Module):
    def __init__(self, num_classes, normal_channel=False, channels_offset: int = None):
        ...
        self.feature_propagation1 = PointNetFeaturePropagation(in_channel=150+additional_channel, mlp=[128, 128])
    ...
    def forward(self, xyz, cls_label):
        ...
        l0_points = self.feature_propagation1(l0_xyz, l1_xyz, torch.cat([cls_label_one_hot,l0_xyz,l0_points],1), l1_points)
        # FC layers
